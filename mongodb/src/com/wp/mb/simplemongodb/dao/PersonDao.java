...
import com.wp.mb.simplemongodb.converter.PersonConverter;
...
public class PersonDao extends EntityDao<Person> {
	...
	public void save(Person person) {
		Map<String, Object> mapPerson = new PersonConverter()
				.converterToMap(person);
		save(mapPerson);
	}

	public void update(Person oldPerson, Person newPerson) {
		Map<String, Object> query = new PersonConverter()
				.converterToMap(oldPerson);
		Map<String, Object> map = new PersonConverter()
				.converterToMap(newPerson);
		update(query, map);
	}
